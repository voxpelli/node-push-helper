...
exports.PuSHHelper.handshake = function(request, response, callback) {
  ...
  if (request.method === 'GET' && hub_mode === 'subscribe' && (hub_challenge != null) && hub_challenge.length > 0) {
    body = hub_challenge;
    headers = {
...
exports.PuSHHelper.check_signature = function(request, response, next) {
  if (request.method === 'GET') {
    next();
  } else if (request["calculated-signature"] !== undefined && request["calculated-signature"] !== null) {
